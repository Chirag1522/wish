...
export default function MemoriesCard() {
    ...
    const memories = [
    "Your love and care have always made every moment feel special.",
    "The warmth and support you give mean more than words can express.",
    "You always know how to bring comfort and happiness to everyone around you.",
    "The memories created with you will always hold a special place in my heart.",
    "Thank you for being a constant source of love, strength, and positivity.",
]
